				...
				if (options.validateOnBlur) {
					input
						...
						.on('blur.xdsoft', function () {
							if (options.allowBlank && (!$.trim($(this).val()).length || (typeof options.mask == "string" && $.trim($(this).val()) === options.mask.replace(/[0-9]/g, ''))))
							{
								$(this).val(null);
...
//						console.log("onGenerate");
			...
			setPos = function () {
				/**
                 * ä¿®å¤è¾“å…¥æ¡†åœ¨windowæœ€å³è¾¹ï¼Œä¸”è¾“å…¥æ¡†çš„å®½åº¦å°äºŽæ—¥æœŸæŽ§ä»¶å®½åº¦æƒ…å†µä¸‹ï¼Œæ—¥æœŸæŽ§ä»¶æ˜¾ç¤ºä¸å…¨çš„bugã€‚
