    ...
    public function sendMail($users_id)
    {
        ...
        if (!empty(json_decode($result->admin_id_tourism))) {
            foreach (json_decode($result->admin_id_tourism) as $key => $value) {
                ...
                $message_noti = 'แบบประเมินของ ' . $result->attraction_name_th . ' สามารถแก้ไขผลการประเมินได้ กรุณาล็อกอินเข้าสู่เว็บไซต์ เพื่อแก้ไขผลการประเมิน และส่งผลประเมินเข้าระบบอีกครั้ง หรือหากท่านไม่ต้องการแก้ไขผลการประเมิน ให้ท่านล็อกอินเข้าสู่เว็บไซต์และกดส่งผลประเมินเข้าระบบอีกครั้ง';
                $email_data = [
