    ...
    const signin = {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.result == 'success') {
                            ...
                            message = 'กดปุ่ม "ตกลง" เพื่อยังหน้าเข้าสู่ระบบ';
                            link = '<?=base_url('login')?>';
                            <?php else : ?>
                            message = 'กดปุ่ม "ตกลง" เพื่อยังหน้าข้อมูลส่วนตัว';
        ...
        validation: function() {
            ...
            if(Number(lg) == 1 && passwordNew == passwordOld){                
                alert.show('error','ไม่สามารถเปลี่ยนรหัสผ่านใหม่ได้', 'กรุณากรอกรหัสผ่านใหม่ให้ไม่เหมือนกับรหัสผ่านเดิม');
                return false;
            }
