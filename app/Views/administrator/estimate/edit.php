        ...
        <div class="backendform-row">
          ...
          ?>
            <div class="backendform-col3">
              ...
              <div class="editjudge-out">
                <select class="js-example-basic-multiple" id="status_4" name="lowcarbon[]" multiple>
                  <?php
                  if (!empty($status_4)) {
...
<script>
  ...
  function validated() {
    ...
    var status_4 = $('#status_4 option:selected').map(function(i, e) {
      return $(e).val();
    }).get();
    ...
    if (question[4] != null) {
      if (status_4.length < 1) {
        toastr.error('กรุณาระบุกรรมการสำหรับ Low Carbon อย่างน้อย 1 คน');
        return false;
      }
    }
