<div class="regis-form-data-row">
  ...
  <div class="regis-form-data-col1">
    ...
    <p><input type="radio" id="step5-t3-bussCites-0" value="0" <?= ($result->buss_cites == 0) ? 'checked' : ''; ?>> ไม่ประกอบกิจการ</p>
    <p><input type="radio" id="step5-t3-bussCites-1" value="1" <?= ($result->buss_cites == 1) ? 'checked' : ''; ?>> ประกอบกิจการ</p>
  </div>
  <div class="regis-form-data-col1">
    <h4>ผู้ส่งผลงานจะต้องไม่มีส่วนได้ส่วนเสียกับการท่องเที่ยวแห่งประเทศไทย (ททท.) ทั้งทางตรงและทางอ้อม</h4>
    <p><input type="radio" id="step5-t3-nominee-1" value="1" <?= ($result->admin_nominee == 1) ? 'checked' : ''; ?>> มีส่วนได้ส่วนเสีย</p>
    <p><input type="radio" id="step5-t3-nominee-0" value="0" <?= ($result->admin_nominee == 0) ? 'checked' : ''; ?>> ไม่มีส่วนได้ส่วนเสีย</p>
  </div>
  <div class="bs-row">
    <span class="fs-18 fw-semibold">แนบเอกสาร</h4>
      ...
      <div class="bs-row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 mb-4">
          ...
          <div class="card col-md-6" style="border: 1px solid #E5E6ED;">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 mb-4">
          ...
          <div class="card col-md-6" style="border: 1px solid #E5E6ED;">
            <div class="card-body selecter-file">
              ...
              if (!empty($result->pack_file) && !empty(json_decode($result->pack_file))) {
                foreach (json_decode($result->pack_file) as $key => $value) {
                  if ($value->file_position == 'spaMangerCertFiles') {
              ?>
                    <div class="card card-body">
                      <div class="bs-row">
                        <div class="col-12"> <span class="fs-file-name"><?= $value->file_original ?> (<?= $value->file_size ?> Mb)</span>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 mb-4">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" id="step5-t3-outlander-1" value="1" <?= ($result->has_outlander == 1) ? 'checked' : ''; ?>>
            <label class="form-check-label mr-2">มี</label>
          </div>
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" id="step5-t3-outlander-0" value="0" <?= ($result->has_outlander == 0) ? 'checked' : ''; ?>>
