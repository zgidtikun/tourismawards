...
if (!empty($result)) {
  ...
  foreach ($result as $key => $value) {
    ...
    $data = [
      ...
      $value->score_pre_origin,  // 'คะแนนที่ได้ (คะแนนดิบ)',
      $value->score_pre_origin * $value->weight, // 'คะแนนที่ได้รับ (รอบลงพื้นที่)', คะแนนดิบ X ค่าน้ำหนักรายข้อ ... $value->tscore_pre
      $value->pre_score, // 'คะแนนเต็ม (รายข้อ)',
