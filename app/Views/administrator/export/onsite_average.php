  ...
  foreach ($result as $key => $value) {
    ...
    if ($value['tourism']) {
      $data = [
        ...
        $value['tourism'][1]->score_onsite,
        $value['tourism'][2]->score_onsite,
        '',
        $value['tourism'][1]->onside_score_total,
    ...
    if ($value['supporting']) {
      $data = [
        ...
        $value['supporting'][1]->score_onsite,
        $value['supporting'][2]->score_onsite,
        '',
        $value['supporting'][1]->onside_score_total,
    ...
    if ($value['responsibility']) {
      $data = [
        ...
        $value['responsibility'][1]->score_onsite,
        $value['responsibility'][2]->score_onsite,
        '',
        $value['responsibility'][1]->onside_score_total,
