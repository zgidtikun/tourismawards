    ...
    <div class="noti-box" style="display: none;">
      ...
      <div class="noti-box-content">
        ...
        <div class="noti-box-txt">
          <ul>
            <li><a href="javascript:">ข้อมูลใบสมัครของท่านอาจยังไม่สมบูรณ์ โปรดดูรายละเอียด เพื่อแก้ไขและส่งใบสมัครอีกครั้ง</a></li>
            <li><a href="javascript:">ใบสมัครของท่านผ่านการอนุมัติ โปรดกรอกข้อมูลแบบประเมินขั้นต้น (Pre-screen)</a></li>
            <li><a href="javascript:">ข้อมูลแบบประเมินขั้นต้น (Pre-screen) ของท่านไม่ผ่านเกณฑ์</a></li>
            <li><a href="javascript:">แจ้งผลการประเมินขั้นต้น (Pre-screen) ของท่านเรียบร้อยแล้ว</a></li>
            <li><a href="javascript:">แจ้งผลการประเมินรอบลงพื้นที่ของท่านเรียบร้อยแล้ว</a></li>
          </ul>
        </div>
      </div>
    </div>
