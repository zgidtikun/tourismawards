  ...
  <div class="col-xl-12 col-xxl-12">
    <div class="card">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" onclick="window.location.href = '<?= base_url('backend/Admin') ?>'"><i class="fas fa-times"></i> ยกเลิก</button>
...
<script>
  $(function() {
    // Active Menu
    var menu = $('#menu');
    var item = $(menu).find("a[href='<?= base_url() ?>/backend/Admin']");
