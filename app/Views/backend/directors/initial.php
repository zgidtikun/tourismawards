        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            <div class="form-group">
              ...
              <!-- <input type="text" class="form-control" name="assessment_group_name[1][]" id="assessment_group_name_1" value="" data-role="tagsinput"> -->
              ...
              <select class="form-control" id="assessment_group_name_1" name="assessment_group_name_1[1][]" multiple="multiple" style="width: 100%">
...
<script>
  $(function () {
    $('#assessment_group_name_1').select2();
  })
</script>