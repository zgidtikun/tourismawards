...
<script src="<?=base_url('assets/js/jquery-3.6.1.min.js') ?>?v=<?=$app->script_v?>" type="text/javascript"></script>
...
<link href="<?=base_url('assets/css/jquery.mmenu.all.css')?>?v=<?=$app->script_v?>" rel="stylesheet" type="text/css">
...
<link href="<?=base_url('assets/css/index-login.css')?>?v=<?=$app->script_v?>" rel="stylesheet" type="text/css">
